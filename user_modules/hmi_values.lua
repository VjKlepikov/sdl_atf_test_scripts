  ...
  hmi_table.UI.GetCapabilities =
  {
    params =
    {
      displayCapabilities =
      {
        ...
        textFields =
        {
          module.createTextField("mainField1"),
          module.createTextField("mainField2"),
          module.createTextField("mainField3"),
          module.createTextField("mainField4"),
          module.createTextField("statusBar"),
          module.createTextField("mediaClock"),
          module.createTextField("mediaTrack"),
          module.createTextField("alertText1"),
          module.createTextField("alertText2"),
          module.createTextField("alertText3"),
          module.createTextField("scrollableMessageBody"),
          module.createTextField("initialInteractionText"),
          module.createTextField("navigationText1"),
          module.createTextField("navigationText2"),
          module.createTextField("ETA"),
          module.createTextField("totalDistance"),
          module.createTextField("navigationText"),
          module.createTextField("audioPassThruDisplayText1"),
          module.createTextField("audioPassThruDisplayText2"),
          module.createTextField("sliderHeader"),
          module.createTextField("sliderFooter"),
          module.createTextField("notificationText"),
          module.createTextField("menuName"),
          module.createTextField("secondaryText"),
          module.createTextField("tertiaryText"),
          module.createTextField("timeToDestination"),
          module.createTextField("turnText"),
          module.createTextField("menuTitle"),
          module.createTextField("locationName"),
          module.createTextField("locationDescription"),
          module.createTextField("addressLines"),
          module.createTextField("phoneNumber")
        },
        imageFields =
        {
          module.createImageField("softButtonImage"),
          module.createImageField("choiceImage"),
          module.createImageField("choiceSecondaryImage"),
          module.createImageField("vrHelpItem"),
          module.createImageField("turnIcon"),
          module.createImageField("menuIcon"),
          module.createImageField("cmdIcon"),
          module.createImageField("showConstantTBTIcon"),
          module.createImageField("locationImage")
        },
        mediaClockFormats =
        {
          "CLOCK1",
