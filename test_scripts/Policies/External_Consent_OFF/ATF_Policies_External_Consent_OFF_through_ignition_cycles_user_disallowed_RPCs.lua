...
--[APPLINK-24706][Policies] External UCS: "OFF" - userDisallowed RPCs
...
local function CheckGroup001IsNotConsentedAndGroup002IsConsented()
  ...
  --------------------------------------------------------------------------
  Test[TEST_NAME_OFF.."MainCheck_RPC_of_Group001_is_user_disallowed"] = function(self)
...
local function CheckGroup001IsConsentedAndGroup002IsNotConsented()
  ...
  --------------------------------------------------------------------------
  Test[TEST_NAME_OFF.."MainCheck_RPC_of_Group002_is_user_disallowed"] = function(self)
