-------------------------------------- Requirement summary -------------------------------------------
-- [APPLINK-22877]: [Policies] External UCS: "ON" status between ignition cycles
-- [APPLINK-22879]: [Policies] External UCS: "ON" in case of omitted "disallowed_by_external_consent_entities" param in functional groupings
--
------------------------------------------------------------------------------------------------------
...
------------------------------------------- Variables ------------------------------------------------
------------------------------------------------------------------------------------------------------
local tmp_ptu_update = "/tmp/ptu_update.json"
...
-- 4. Expected Result: RPC is disallowed
...
Test[TEST_NAME_ON.."Precondition_Update_Policy_Table"] = function(self)
  ...
  common_functions_external_consent:CreateJsonFileForPTU(data, tmp_ptu_update)
  -- remove preload_pt from json file
  local parent_item = {"policy_table","module_config"}
  local removed_json_items = {"preloaded_pt"}
  common_functions:RemoveItemsFromJsonFile(tmp_ptu_update, parent_item, removed_json_items)
  local removed_json_items_preloaded_date = {"preloaded_date"}
  common_functions:RemoveItemsFromJsonFile(tmp_ptu_update, parent_item, removed_json_items_preloaded_date)
  -- update policy table
  common_functions_external_consent:UpdatePolicy(self, tmp_ptu_update)
end
