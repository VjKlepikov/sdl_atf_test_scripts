---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-28546]: [Policies] External UCS: PTU without "disallowed_by_external_consent_entities_off" struct
--
-- Description:
-- In case:
...
--
-- Preconditions:
-- 1. Start SDL (make sure 'disallowed_by_external_consent_entities_off' section is defined in PreloadedPT)
-- 2. Register app1
--
-- Steps:
-- 1. Activate app1
...
-- b. Section "disallowed_by_external_consent_entities_off" doesn't exist
--
