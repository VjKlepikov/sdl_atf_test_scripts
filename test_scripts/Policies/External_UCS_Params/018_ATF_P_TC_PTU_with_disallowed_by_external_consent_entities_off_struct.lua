---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-28548]: [Policies] External UCS: PTU with “disallowed_by_external_consent_entities_off” struct
--
-- Description:
-- In case:
-- SDL receives PolicyTableUpdate with “disallowed_by_external_consent_entities_off:
...
-- b. add this “disallowed_by_external_consent_entities_off:
...
-- 1. Register app1
-- 3. Activate app1
-- 4. Perform PTU (make sure 'disallowed_by_external_consent_entities_off' section is defined)
