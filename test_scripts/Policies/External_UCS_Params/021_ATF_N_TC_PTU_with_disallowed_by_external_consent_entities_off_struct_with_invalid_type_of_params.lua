---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-28545]: [Policies] External UCS: PTU with "disallowed_by_external_consent_entities_off" struct with invalid type of params
--
-- Description:
-- In case:
...
-- 1. Register app
-- 2. Activate app
-- 3. Perform PTU (make sure 'disallowed_by_external_consent_entities_off' section is defined
