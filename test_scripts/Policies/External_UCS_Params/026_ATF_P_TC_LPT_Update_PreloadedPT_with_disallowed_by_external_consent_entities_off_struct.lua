---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-28544]: [Policies] External UCS: PreloadedPT with "disallowed_by_external_consent_entities_off" struct
--
-- Description:
-- In case:
...
-- b. add this "disallowed_by_external_consent_entities_off: [entityType: <Integer>, entityId: <Integer>]"
