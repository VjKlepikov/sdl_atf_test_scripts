---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-28550]: [Policies] External UCS: SnapshotPT with "external_consent_status_groups" param
-- [APPLINK-22873]: [Policies] External UCS: "ON" updates in allowed "consent_groups" and "external_consent_status_groups" when externalConsentStatus changes to "OFF"
--
-- Description:
-- In case:
