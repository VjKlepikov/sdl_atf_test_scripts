---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-28540]: [Policies] External UCS: SnapshotPT without "disallowed_by_external_consent_entities_off" struct
--
-- Description:
-- In case:
-- SDL Policies database omits “disallowed_by_external_consent_entities_off:
...
-- SDL must:
-- omit this "disallowed_by_external_consent_entities_off: [entityType: <Integer>, entityId: <Integer>]" field
...
--
-- Expected result:
-- Section "disallowed_by_external_consent_entities_off" is omitted
--
