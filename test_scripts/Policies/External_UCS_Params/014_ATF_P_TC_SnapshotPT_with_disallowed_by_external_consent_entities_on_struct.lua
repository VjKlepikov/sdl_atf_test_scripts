---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [APPLINK-22762]: [Policies] External UCS: SnapshotPT with "disallowed_by_external_consent_entities_on" struct
--
-- Description:
-- In case:
-- SDL Policies database contains “disallowed_by_external_consent_entities_on:
...
-- SDL must:
-- include this “disallowed_by_external_consent_entities_on:
...
--
-- Preconditions:
-- 1. Make sure 'disallowed_by_external_consent_entities_on' section is defined in PreloadedPT
-- 2. Start SDL
--
-- Steps:
-- 1. Register app
...
--
-- Expected result:
-- PTSnapshot contains 'disallowed_by_external_consent_entities_on' section
--
