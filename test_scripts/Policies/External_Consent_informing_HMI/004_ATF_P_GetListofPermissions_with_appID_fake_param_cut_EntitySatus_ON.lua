...
--
-- Description:
-- SDL ignores the fake parameter received and stores internally the received <externalConsentStatus> (status = ON)
...
-- (all other params present and within bounds, EntityStatus = 'ON')
