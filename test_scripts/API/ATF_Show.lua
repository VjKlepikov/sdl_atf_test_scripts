...
local function SequenceChecks()
	...
	--Description:
		...
		-- 	local CorrIdUnsub = self.mobileSession:SendRPC("UnsubscribeButton", { buttonName = "CUSTOM_BUTTON" })
		...
		function Test:Show_TC_Show_01_Step2_01()
			...
			:Do(function()
					...
					--mobile side: notifications are not sent to mobile app
					EXPECT_NOTIFICATION("OnButtonEvent",
						{ customButtonID = 8, buttonEventMode = "BUTTONDOWN", buttonName = "CUSTOM_BUTTON"},
						{ customButtonID = 1, buttonEventMode = "BUTTONUP", buttonName = "CUSTOM_BUTTON"})
					:Times(0)
	...
	--Description: Check for manual test case TC_Show_10:
		...
		function Test:Show_TC_Show_10_Step3()
			...
			--mobile side: notifications are sent to mobile app
			EXPECT_NOTIFICATION("OnButtonEvent",
				{ customButtonID = 2, buttonEventMode = "BUTTONDOWN", buttonName = "CUSTOM_BUTTON"},
		...
		function Test:Show_TC_Show_10_Step4()
			...
			--mobile side: notifications are sent to mobile app
			EXPECT_NOTIFICATION("OnButtonEvent",
				{ customButtonID = 3, buttonEventMode = "BUTTONDOWN", buttonName = "CUSTOM_BUTTON"},
