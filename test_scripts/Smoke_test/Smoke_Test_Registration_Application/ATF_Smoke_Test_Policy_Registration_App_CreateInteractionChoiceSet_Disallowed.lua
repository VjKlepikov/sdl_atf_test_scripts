...
api_name = "CreateInteractionChoiceSet"
...
------------------------------------------- Steps -------------------------------------------
function Test:Verify_CreateInteractionChoiceSet_DISALLOWED()
  if check_api_has_NONE_disallowed_level(check_api_has_NONE_disallowed_level) then
