...
local function showConstantTBT(params, self)
  ...
  :Do(function(_,data)
      self.hmiConnection:SendError(data.id, data.method, "TIMED_OUT", "infoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
    end)
