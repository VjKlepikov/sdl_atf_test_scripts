...
local file_connection  = require('file_connection')
	...
	--Verification criteria: When vrSynonyms are sent and VR isn't available at the moment on current HMI, UNSUPPORTED_RESOURCE is returned as a result of request. Info parameter provides additional information about the case. General request result success=true in case of no errors from other components.

	--Begin Test case ResultCodeCheck
	--Description: Check UNSUPPORTED_RESOURCE resultCode in case VR isn't available at the moment on current HMI
