...
-- Description:
-- In case HMI responds speechCapabilities param or prerecordedSpeech param is invalid
-- SDL must retrieve default value from 'hmi_capabilities.json' file and return to app
-- Preconditions:
-- 1. StartSDL
-- 2. InitHMI
-- Steps:
-- 1. HMI->SDL: TTS.Capabilities (speechCapabilities or prerecordedSpeech is invalid)
-- 2. InitHMIOnready
-- 3. Register App
-- Expected result:
...
---------------------------------------- Steps ---------------------------------------
local function verifyTTSCapabilitiesWhenSpeechCapabilitiesInvalid()
  common_steps:AddNewTestCasesGroup("Test case: HMI sends TTS.GetCapabilities " ..
  "with speechCapabilities is invalid")
...
verifyTTSCapabilitiesWhenSpeechCapabilitiesInvalid()

local function verifyTTSCapabilitiesWhenPrerecordSpeechCapabilitiesInvalid()
  common_steps:AddNewTestCasesGroup("Test case: HMI sends TTS.GetCapabilities " ..
  "with prerecordedSpeechCapabilities is invalid")
  common_steps:StartSDL("Precondition_StartSDL")
  common_steps:InitializeHmi("Precondition_InitHMI")
...
verifyTTSCapabilitiesWhenPrerecordSpeechCapabilitiesInvalid()
