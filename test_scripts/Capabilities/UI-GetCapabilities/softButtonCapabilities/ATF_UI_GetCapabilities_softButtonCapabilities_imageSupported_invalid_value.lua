...
-- Preconditions:
-- 1. HMI -> SDL: invalid value of softButtonCapabilities.imageSupported in UI.GetCapabilities

-- Steps:
-- 1. Register App

-- Expected result:
-- SDL -> Mob: value softButtonCapabilities.imageSupported from hmi_capabilities.json file
---------------------------------------------------------------------------------------------
