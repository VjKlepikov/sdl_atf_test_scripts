...
--[[ Local Functions ]]
local function unexpectedDisconnect_VR_Addcommand(params)
...
runner.Title("Test")
runner.Step("Unexpected disconnect before response VR.AddCommand",
  unexpectedDisconnect_VR_Addcommand, { requestParams })
